  ...
  return (
    <div className="HostHomeProvider">
      ...
      <div classname="DownloadButtonBox">
        <button classname="DownloadButtons"> CLC HHP Application </button>
        <button classname="DownloadButtons"> Caps Check Form </button>
      </div>
      <p> Download to View Frequently Asked Questions </p>
        <button classname="DownloadButtons"> Frequently Asked Questions </button>
        <h2> Minimum Qualifications </h2>
          <div className="LiStyling">
            ...
            <li> Excellent interpersonal skills to engage with families and clients who have developmental disabilities. </li>
            ...
            <li> Prior experience and knowledge of working with the developmentally disabled population. </li>
          </div>
        </div>
